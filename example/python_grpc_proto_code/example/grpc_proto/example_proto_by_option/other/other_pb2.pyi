...
class SubSubSubNestedMessage(google.protobuf.message.Message):
    ...
    def repeated_demo(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DemoMessage]: ...
    def __init__(
        self,
        *,
...
class SubSubNestedMessage(google.protobuf.message.Message):
    ...
    def map_demo(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___SubSubSubNestedMessage]: ...
    def __init__(
        self,
        *,
...
class SubNestedMessage(google.protobuf.message.Message):
    ...
    def repeated_demo(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SubSubNestedMessage]: ...
    def __init__(
        self,
        *,
