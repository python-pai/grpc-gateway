...
# source: example/grpc_proto/example_proto_by_option/user/user.proto
...
CreateUserRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "example.grpc_proto.example_proto_by_option.user.user_pb2"
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CREATEUSERREQUEST.fields_by_name[
        "uid"
    ]._serialized_options = b"\212C\005r\003\320\001\001\212C\nr\010\362\001\00510086\212C\010r\006\222\002\003UID\212C\022r\020\342\001\ruser union id"
    _CREATEUSERREQUEST.fields_by_name["user_name"]._options = None
    _CREATEUSERREQUEST.fields_by_name[
        "user_name"
    ]._serialized_options = (
        b"\212C\016r\014\342\001\tuser name\212C\004r\002\030\001\212C\004r\002 \n\212C\tr\007\362\001\004so1n"
    )
    _CREATEUSERREQUEST.fields_by_name["password"]._options = None
    _CREATEUSERREQUEST.fields_by_name[
        "password"
    ]._serialized_options = b"\212C\022r\020\342\001\ruser password\212C\007r\005\332\001\002pw\212C\004r\002\030\006\212C\004r\002 \022\212C\013r\t\362\001\006123456"
    _LOGINUSERRESULT.fields_by_name["uid"]._options = None
    _LOGINUSERRESULT.fields_by_name[
        "uid"
    ]._serialized_options = (
        b"\212C\nr\010\362\001\00510086\212C\010r\006\222\002\003UID\212C\022r\020\342\001\ruser union id"
    )
    ...
    _USER.methods_by_name[
        "get_uid_by_token"
    ]._serialized_options = (
        b"\212\323\344\223\002+\252\001\004user\262\001\036\n\tgrpc-user\022\021grpc_user_service\310\001\001"
    )
    _USER.methods_by_name["logout_user"]._options = None
    _USER.methods_by_name[
        "logout_user"
    ]._serialized_options = b"\212\323\344\223\002MJ\016\n\014/user/logout\262\001\036\n\tgrpc-user\022\021grpc_user_service\272\001\031User exit from the system"
    _USER.methods_by_name["login_user"]._options = None
    _USER.methods_by_name[
        "login_user"
    ]._serialized_options = b"\212\323\344\223\002GJ\r\n\013/user/login\262\001\036\n\tgrpc-user\022\021grpc_user_service\272\001\024User login to system"
    _USER.methods_by_name["create_user"]._options = None
    _USER.methods_by_name[
        "create_user"
    ]._serialized_options = b"\212\323\344\223\002{J\016\n\014/user/create\262\001\036\n\tgrpc-user\022\021grpc_user_service\262\001%\n\020grpc-user-system\022\021grpc_user_service\272\001\037Create users through the system"
    _USER.methods_by_name["delete_user"]._options = None
    _USER.methods_by_name[
        "delete_user"
    ]._serialized_options = b"\212\323\344\223\002\233\001J\016\n\014/user/delete\262\001\036\n\tgrpc-user\022\021grpc_user_service\262\001%\n\020grpc-user-system\022\021grpc_user_service\302\001?This interface performs a logical delete, not a physical delete"
    _SEXTYPE._serialized_start = 907
    _SEXTYPE._serialized_end = 936
    _CREATEUSERREQUEST._serialized_start = 239
    _CREATEUSERREQUEST._serialized_end = 507
    _DELETEUSERREQUEST._serialized_start = 509
    _DELETEUSERREQUEST._serialized_end = 541
    _LOGINUSERREQUEST._serialized_start = 543
    _LOGINUSERREQUEST._serialized_end = 592
    _LOGINUSERRESULT._serialized_start = 595
    _LOGINUSERRESULT._serialized_end = 771
    _LOGOUTUSERREQUEST._serialized_start = 773
    _LOGOUTUSERREQUEST._serialized_end = 830
    _GETUIDBYTOKENREQUEST._serialized_start = 832
    _GETUIDBYTOKENREQUEST._serialized_end = 869
    _GETUIDBYTOKENRESULT._serialized_start = 871
    _GETUIDBYTOKENRESULT._serialized_end = 905
    _USER._serialized_start = 939
    _USER._serialized_end = 1860
