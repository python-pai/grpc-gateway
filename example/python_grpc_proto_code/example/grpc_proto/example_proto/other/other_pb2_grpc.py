...
from example.python_grpc_proto_code.example.grpc_proto.example_proto.other import other_pb2 as example_dot_grpc__proto_dot_example__proto_dot_other_dot_other__pb2
...
class OtherStub(object):
    ...
    def __init__(self, channel):
        ...
        self.nested_demo = channel.unary_unary(
                ...
                response_deserializer=example_dot_grpc__proto_dot_example__proto_dot_other_dot_other__pb2.NestedMessage.FromString,
                )
...
def add_OtherServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'nested_demo': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=example_dot_grpc__proto_dot_example__proto_dot_other_dot_other__pb2.NestedMessage.SerializeToString,
            ),
    }
...
class Other(object):
    ...
    def nested_demo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/other_social.Other/nested_demo',
            ...
            example_dot_grpc__proto_dot_example__proto_dot_other_dot_other__pb2.NestedMessage.FromString,
